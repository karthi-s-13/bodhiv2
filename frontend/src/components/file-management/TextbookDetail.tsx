...
export const TextbookDetail: React.FC<TextbookDetailProps> = ({
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', minHeight: 0 }}>
      ...
      {/* Tabs Menu */}
      <div className="viewer-tabs" style={{ display: 'flex', borderBottom: '1px solid var(--border-glass)', marginBottom: '16px', gap: '8px', overflowX: 'auto', flexShrink: 0 }}>
        <button
      ...
      {/* Tab Panels */}
      <div style={{ flexGrow: 1, minHeight: 0, display: 'flex', flexDirection: 'column', overflowY: 'auto' }}>
