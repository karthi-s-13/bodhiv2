    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', minHeight: 0 }}>
      ...
      <div className="viewer-tabs" style={{ display: 'flex', borderBottom: '1px solid var(--border-glass)', marginBottom: '16px', gap: '8px' }}>
        <button
          ...
          className={`viewer-tab-btn ${activeTab === 'curriculum' ? 'active' : ''}`}
          style={{
            padding: '10px 16px',
            background: 'none',
            border: 'none',
            borderBottom: activeTab === 'curriculum' ? '2px solid var(--color-primary)' : '2px solid transparent',
            color: activeTab === 'curriculum' ? 'var(--text-primary)' : 'var(--text-muted)',
            cursor: 'pointer',
            fontWeight: 600,
            fontSize: '0.9rem',
        ...
        >
          <span style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            <Map size={16} style={{ color: activeTab === 'curriculum' ? 'var(--color-primary)' : 'inherit' }} />
            Curriculum Map
          </span>
        </button>
        <button
